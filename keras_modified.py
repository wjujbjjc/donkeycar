...
from tensorflow.keras.layers import Conv3D, MaxPooling3D, Conv2DTranspose,Conv2D
...
def core_cnn16_layers(img_in, drop, l4_stride=1):
    """
    Returns the core CNN layers that are shared among the different models,
    like linear, imu, behavioural
...
def default_n_linear(num_outputs, input_shape=(120, 160, 3)):
    ...
    x = core_cnn16_layers(img_in, drop)
